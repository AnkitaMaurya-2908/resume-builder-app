        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              {/* progress bar */}
              <hr className='absoulte top-0 left-0 right-0 border-2 border-gray-200' />
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                ...
                <div className='flex items-center'>
                  {activeSectionIndex !== 0 && (
                    <button onClick={() => setActiveSectionIndex((prevIndex) => Math.max(prevIndex - 1, 0))} className='flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg0gray-50 transition-all' disabled={activeSectionIndex === 0}>
